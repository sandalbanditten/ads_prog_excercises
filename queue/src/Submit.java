...
public class Submit {
  ...
  public static void main(String[] args) {
    ...
    // Uncomment the following line, and add the needed task id, username and
    // password
    // to submit the code to the server
    // QueueSimulation.testAll();
    submit("queue", "ads25-dj7089", "JAJkpV5wHDj1iMo4");
  }
  ...
  public Submit() throws IOException {
    ...
    finishBoundaryBytes = ("--" + boundary + "--").getBytes("UTF-8");
  }
  ...
  private String getSubmissionJudging(String submissionId) throws IOException {
    ...
    if (pos != -1) {
      ...
      if (code.equals("correct"))
        throw new RuntimeException("Incorrect and correct");
      return code;
    }
